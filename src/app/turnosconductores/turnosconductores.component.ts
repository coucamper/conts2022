...
@Component({
  selector: 'app-turnosconductores',
  templateUrl: './turnosconductores.component.html',
  styleUrls: ['./turnosconductores.component.css']
})
export class TurnosconductoresComponent implements OnInit {
  turno:TurnoModel;
