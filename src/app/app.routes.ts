...
export const APP_ROUTES: Routes = [
    ...
    { path: 'revisiones', component: RevisionesVehiculoComponent },
    { path: 'averias', component: AveriasveComponent },
    ...
    { path: 'exportaciones', component: ExportacionComponent },
    { path: 'clases', component: ClasesComponent },
    { path: 'clientes', component: ClientesComponent},
    { path: 'llenados', component: LlenadosComponent},
    { path: 'insertarcarga', component: SalvarcargaComponent },
